...
function serverHandler(request, response) {
    try {
        ...
        //Changed server name from Signaling-Server.js' to 'Signaling-Server-join-only.js'
        if (filename && filename.search(/server.js|Scalable-Broadcast.js|Signaling-Server-join-only.js/g) !== -1) {
...
function runServer() {
    ...
    //Changed server name from Signaling-Server.js' to 'Signaling-Server-join-only.js'
    require('./Signaling-Server-join-only.js')(app, function (socket) {
        try {

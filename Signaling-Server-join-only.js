...
module.exports = exports = function (app, socketCallback) {
    ...
    function onConnection(socket) {
        ...
        // Applied changes in below method for join a room, all other demos might not work due to this changes.
        function joinARoom(message) {
            ...
            // Set roomId as extra data when a user joins a room, and a user will join all other users whose roomId is same as its roomId.
            var inviteTheseUsers = [];
            for (var name in listOfUsers) {
                if (listOfUsers[name].extra.roomId === message.remoteUserId) {
                    inviteTheseUsers.push(listOfUsers[name].socket);
                }
            }
            ...
            inviteTheseUsers.forEach(function (userSocket) {
                ...
                if (params.oneToMany && userSocket.userid !== listOfUsers[message.remoteUserId].extra.roomI) return;
